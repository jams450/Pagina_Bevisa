        ...
        <div class="row">
          <div class="col-md-3">
            <div class="btn-group-vertical wow fadeInLeft">
                ...
                <button type="button" onclick="esconder('#Coloreshidro')" class="btn btn-secondary">Colores Hidrosolubles</button>
                <button type="button" onclick="esconder('#Saboresliquido')" class="btn btn-secondary">Sabores Liquidos</button>
          ...
          <div id="Coloresgel" class="col-md-9 hidden d-none ">
              ...
              <div class="row">
                <div class="col-md-4">
                  <img  class="img-thumbnail img-fluid" src="/img/index_recetas.jpg">
                </div>
                <div class="col-md-4">
                  <img  class="img-thumbnail img-fluid" src="/img/index_recetas.jpg">
                </div>
